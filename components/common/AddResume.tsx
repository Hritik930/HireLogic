...
const AddResume = ({ userId }: { userId: string | undefined }) => {
  ...
  return (
    <>
      <div
        className="relative flex aspect-[1/1.2] cursor-pointer items-center justify-center rounded-xl border border-dashed border-sky-300/80 bg-gradient-to-b from-sky-100/70 to-indigo-100/60 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg dark:border-sky-600/60 dark:from-slate-900/80 dark:to-slate-800/80"
        onClick={() => userId && setOpenDialog(true)}
      >
        <PlusSquare className="h-14 w-14 text-sky-700 dark:text-sky-300" />
      </div>
